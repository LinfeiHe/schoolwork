...
def train_model(model, criterion, optimizer, scheduler, num_epochs=25):
    ...
    torch.save(best_model_wts, 'best_model_wts_resnet152.pkl')
    torch.save(best_acc, 'best_acc_resnet152.pkl')
    return model
...
"""
train Loss: 0.0454 Acc1: 0.6555 Acc3: 0.8340
val iter: 200.0000 Loss_path: 162.5756
val Loss: 0.0294 Acc1: 0.7646 Acc3: 0.9211

Training complete in 138m 39s
Best val Acc: 0.927528
"""