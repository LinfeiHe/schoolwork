...
def train_model(model, criterion, optimizer, scheduler, num_epochs=25):
    ...
    torch.save(best_model_wts, 'best_model_wts_densenet161.pkl')
    torch.save(best_acc, 'best_acc_densenet161.pkl')
    return model
...
"""
train Loss: 0.0455 Acc1: 0.6588 Acc3: 0.8365
val iter: 200.0000 Loss_path: 161.6622
val Loss: 0.0290 Acc1: 0.7615 Acc3: 0.9225
"""